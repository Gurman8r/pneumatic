...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    PushStyleVar(ImGuiStyleVarType_WindowPadding, ImVec2(style.FramePadding.x, style.WindowPadding.y));
...
bool ImGui::BeginMainMenuBar()
{
    ...
    PushStyleVar(ImGuiStyleVarType_WindowMinSize, ImVec2(0, 0));    // Lift normal size constraint, however the presence of a menu-bar will give us the minimum height we want.
...
bool ImGui::BeginMenu(const char* label, bool enabled)
{
    ...
    if (window->DC.LayoutType == ImGuiLayoutType_Horizontal)
    {
        ...
        PushStyleVar(ImGuiStyleVarType_ItemSpacing, ImVec2(style.ItemSpacing.x * 2.0f, style.ItemSpacing.y));
...
bool ImGui::TabItemLabelAndCloseButton(ImDrawList* draw_list, const ImRect& bb, ImGuiTabItemFlags flags, ImVec2 frame_padding, const char* label, ImGuiID tab_id, ImGuiID close_button_id, bool is_contents_visible)
{
    ...
    if (close_button_visible)
    {
        ...
        PushStyleVar(ImGuiStyleVarType_FramePadding, frame_padding);
