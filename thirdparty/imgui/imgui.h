...
typedef int ImGuiStyleVar;          // -> enum ImGuiStyleVarType_        // Enum: A variable identifier for styling
...
enum ImGuiStyleVarType_
{
    // Enum name --------------------- // Member in ImGuiStyle structure (see ImGuiStyle for descriptions)
    ImGuiStyleVarType_Alpha,               // float     Alpha
    ImGuiStyleVarType_WindowPadding,       // ImVec2    WindowPadding
    ImGuiStyleVarType_WindowRounding,      // float     WindowRounding
    ImGuiStyleVarType_WindowBorderSize,    // float     WindowBorderSize
    ImGuiStyleVarType_WindowMinSize,       // ImVec2    WindowMinSize
    ImGuiStyleVarType_WindowTitleAlign,    // ImVec2    WindowTitleAlign
    ImGuiStyleVarType_ChildRounding,       // float     ChildRounding
    ImGuiStyleVarType_ChildBorderSize,     // float     ChildBorderSize
    ImGuiStyleVarType_PopupRounding,       // float     PopupRounding
    ImGuiStyleVarType_PopupBorderSize,     // float     PopupBorderSize
    ImGuiStyleVarType_FramePadding,        // ImVec2    FramePadding
    ImGuiStyleVarType_FrameRounding,       // float     FrameRounding
    ImGuiStyleVarType_FrameBorderSize,     // float     FrameBorderSize
    ImGuiStyleVarType_ItemSpacing,         // ImVec2    ItemSpacing
    ImGuiStyleVarType_ItemInnerSpacing,    // ImVec2    ItemInnerSpacing
    ImGuiStyleVarType_IndentSpacing,       // float     IndentSpacing
    ImGuiStyleVarType_ScrollbarSize,       // float     ScrollbarSize
    ImGuiStyleVarType_ScrollbarRounding,   // float     ScrollbarRounding
    ImGuiStyleVarType_GrabMinSize,         // float     GrabMinSize
    ImGuiStyleVarType_GrabRounding,        // float     GrabRounding
    ImGuiStyleVarType_TabRounding,         // float     TabRounding
    ImGuiStyleVarType_ButtonTextAlign,     // ImVec2    ButtonTextAlign
    ImGuiStyleVarType_SelectableTextAlign, // ImVec2    SelectableTextAlign
    ImGuiStyleVarType_COUNT
};
...
// During the frame, use ImGui::PushStyleVar(ImGuiStyleVarType_XXXX)/PopStyleVar() to alter the main style values,
