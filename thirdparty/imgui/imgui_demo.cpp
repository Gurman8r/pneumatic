...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        if (ImGui::TreeNode("Grid"))
        {
            ...
            if (winning_state)
                ImGui::PushStyleVar(ImGuiStyleVarType_SelectableTextAlign, ImVec2(0.5f + 0.5f * cosf(time * 2.0f), 0.5f + 0.5f * sinf(time * 3.0f)));
        ...
        if (ImGui::TreeNode("Alignment"))
        {
            ...
            for (int y = 0; y < 3; y++)
            {
                for (int x = 0; x < 3; x++)
                {
                    ...
                    ImGui::PushStyleVar(ImGuiStyleVarType_SelectableTextAlign, alignment);
    ...
    if (ImGui::TreeNode("Vertical Sliders"))
    {
        ...
        ImGui::PushStyleVar(ImGuiStyleVarType_ItemSpacing, ImVec2(spacing, spacing));
        ...
        for (int i = 0; i < 4; i++)
        {
            if (i > 0) ImGui::SameLine();
            ImGui::PushID(i);
            ImGui::PushStyleVar(ImGuiStyleVarType_GrabMinSize, 40);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        // Child 2: rounded border
        {
            ...
            ImGui::PushStyleVar(ImGuiStyleVarType_ChildRounding, 5.0f);
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        ImGui::PushStyleVar(ImGuiStyleVarType_FrameRounding, 3.0f);
        ImGui::PushStyleVar(ImGuiStyleVarType_FramePadding, ImVec2(2.0f, 1.0f));
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::PushStyleVar(ImGuiStyleVarType_ItemSpacing, ImVec2(2, 0));
            ImGui::PushStyleVar(ImGuiStyleVarType_FramePadding, ImVec2(2, 0));
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Delete?", NULL, ImGuiWindowFlags_AlwaysAutoResize))
        {
            ...
            ImGui::PushStyleVar(ImGuiStyleVarType_FramePadding, ImVec2(0, 0));
...
static void ShowDemoWindowColumns()
{
    ...
    if (disable_indent)
        ImGui::PushStyleVar(ImGuiStyleVarType_IndentSpacing, 0.0f);
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        ImGui::PushStyleVar(ImGuiStyleVarType_ItemSpacing, ImVec2(0, 0));
...
static void ShowExampleAppPropertyEditor(bool* p_open)
{
    ...
    ImGui::PushStyleVar(ImGuiStyleVarType_FramePadding, ImVec2(2, 2));
    ImGui::Columns(2);
    ImGui::Separator();
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("Canvas"))
        {
            ...
            //      ImGui::PushStyleVar(ImGuiStyleVarType_WindowPadding, ImVec2(0, 0));      // Disable padding
...
void ShowExampleAppDockSpace(bool* p_open)
{
    ...
    if (!opt_padding)
        ImGui::PushStyleVar(ImGuiStyleVarType_WindowPadding, ImVec2(0.0f, 0.0f));
